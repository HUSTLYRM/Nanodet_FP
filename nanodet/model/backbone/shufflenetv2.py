...
class ShuffleNetV2(nn.Module):
    def __init__(
        ...
        out_stages=(2, 3, 4),                   # 输出阶段，输出给neck阶段
        ...
        if model_size == "0.5x":
            ...
            self._stage_out_channels = [24, 116, 232, 464, 1024]            # 模型大小为1.0时，输出通道数
        ...
        # 后面几个阶段 name: [2,3,4]      repeats: [4,8,4]    output_channels: [116,232,464]        @ TODO: 这里用了[1:] 切片，不应该是后四个了吗？
